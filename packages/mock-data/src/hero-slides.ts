...
export const heroSlides: HeroSlide[] = [
  {
    ...
    description:
      "350 gr mat kuşe kâğıtta 4+4 dijital baskı, 1.000 adet kartvizit 1-2 iş gününde kapınızda.",
  ...
  },
  {
    ...
    description: "440 gr UV dayanıklı vinil branda — istediğiniz ebatta, halkalı veya katlamalı.",
  ...
  },
  {
    ...
    description:
      "Sublime baskılı 330 ml seramik kupa — yıkamada solmaz, kurumsal hediyenizin yıllarca masada kalması için.",
  ...
  },
  {
    ...
    description:
      "Profesyonel grafik ekibimizle çalışın — kartvizitten büyük formata, brief'ten teslime kadar her adımda yanınızdayız. Sınırsız revize. Ek ücret yok.",
