...
### 2.2 Asla Kullanılmayacaklar

- Rakip marka isimleri (public içerikte kesinlikle)
- "belki", "sanırız", "umarız", "deneyebilirsiniz"
- "Kaliteli", "uygun fiyatlı" (genel, kanıtlanmamış sıfatlar)
...
| Yerine | Kullan |
|---|---|
| "Satın al" | "Siparişini ver", "Sepete ekle" |
| "Kaliteli ürün" | "350 gr mat kuşe", "Ofset baskı, CMYK renk profili" |
| "Hızlı teslimat" | "Üretim biter bitmez aynı gün kargoya" |
| "Uygun fiyat" | "1.000 adetten başlayan fiyatlar" |
| "İletişime geçin" | "Bize yazın", "WhatsApp'tan ulaşın" |
| "Müşterilerimiz" | Kişiye hitap: "siz", "siparişiniz" |
...
- Başlıklar **Title Case değil Sentence case** (sadece ilk harf büyük, özel isimler hariç)
- Başlıkta nokta yok
- Başlıkta ünlem işareti maksimum bir adet (sadece CTA bölümlerinde)

### 3.2 Paragraf Uzunluğu

- Web kopyası: maksimum 3 cümle / paragraf
- Yardım merkezi: 2-4 cümle / paragraf, ardından liste
- Blog: 4-6 cümle kabul edilebilir
- Ürün açıklaması giriş: 1-2 güçlü cümle, ardından özellikler listesi

### 3.3 Liste Kuralları

- Madde başına en fazla 10 kelime (liste öğesi uzun cümle değildir)
- Her madde paralel yapıda başlar (hepsi fiil veya hepsi isim)
- 7'den fazla maddede kategori grupla
...
## 4. Müşteri Tiplerine Göre Hitap
...
- Resmi fakat donuk değil
- Verim + güvenilirlik odaklı: teslim süresi, iade politikası, cari hesap
- Örnek: *"Yıllık baskı hacminize göre cari hesap avantajlarını inceleyin."*
...
CTA: net eylem
"Adet seçin, fiyatı görün"
```

### 5.2 Yardım Merkezi

- Soru formatı başlık: "Tasarımımı nasıl gönderebilirim?"
- Cevap: önce tek cümle özet, sonra adımlar
- İlgili konu linkleri: her makalenin sonunda

### 5.3 Blog

- Başlık: fayda odaklı soru veya sayı listeleri
  - ✅ "Kartvizit seçerken dikkat etmeniz gereken 5 şey"
  - ✅ "350 gr ile 400 gr kartvizit arasındaki fark"
  - ❌ "Markala'nın harika yeni kartvizitleri"
- Giriş: birinci kişi (biz) değil ikinci kişi (siz)
- Sonuç: tek pratik çıkarım veya CTA
...
## 7. İçerik Kalite Kontrolü (Yayın Öncesi Kontrol Listesi)
...
- [ ] Türkçe karakter hatası var mı? (ş, ğ, ı, İ, ç, ö, ü)
- [ ] Mobil görünümde metin taşıyor mu?
...
❌ **Önce:**
"Bir sorun oluştu. Lütfen tekrar deneyin veya bizimle iletişime geçin."

✅ **Sonra:**
"Dosya yüklenemedi. Desteklenen formatlar: PDF, TIFF, AI (maks. 50 MB). Sorun devam ederse WhatsApp'tan yardım alın."
