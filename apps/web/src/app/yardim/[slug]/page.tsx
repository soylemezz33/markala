...
const articles: Record<string, HelpArticle> = {
  ...
  "kargo": {
    ...
    content: [
      ...
      { heading: "Kargo Ücretleri", body: "1.500 TL ve üzeri tüm siparişler için kargo ücretsizdir. Altındaki siparişlerde 79 TL standart kargo ücreti uygulanır. Hızlı kargo (1 iş günü) +89 TL ile mümkün (sipariş notunda belirtilmeli)." },
        ...
        <div className="mt-10 p-5 bg-paper-100 border border-paper-200 rounded-xl flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-ink-500 mt-1">
              ...
              ya da <a href="https://wa.me/905057417028" className="text-brand-700 hover:underline font-medium">WhatsApp</a> ile yazın.
            </p>
          </div>
        </div>
      </Container>
