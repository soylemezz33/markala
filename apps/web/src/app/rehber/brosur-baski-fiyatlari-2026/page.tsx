...
export default async function BrosurFiyatlariPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: `Üretim süresi ${matrix.productionTime || URETIM_SURESI}; kargo Türkiye geneli ${KARGO_SURESI} sürer. Yoğun kampanya dönemleri için siparişi dağıtım tarihinden birkaç gün önce vermeni öneririz.`,
    },
  ];
