...
const STATIC_ROUTES = [
  ...
  // Rehber sayfaları — lib/guides.ts kayıt defterinden otomatik (fiyatlar canlı katalogdan
  // SSR, ISR 3600; AI cevap motoru görünürlüğü). İndeks + şablon aracı da girer.
  { path: "/rehber", priority: 0.85, freq: "weekly" as const },
  ...guides.map((g) => ({
    path: `/rehber/${g.slug}`,
    priority: 0.85,
