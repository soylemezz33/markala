...
const items = [
  ...
  { icon: Sparkle, text: "Üretim biter bitmez aynı gün kargoya teslim" },
...
export function PromoMarquee() {
  return (
    <div className="relative bg-ink-900 text-paper-50 overflow-hidden border-b border-white/5">
      ...
      >
        {repeated.map((item, i) => (
          <span key={i} className="inline-flex items-center gap-2 text-xs md:text-sm font-medium text-paper-50/85">
