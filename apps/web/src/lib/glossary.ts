...
export const glossary: GlossaryTerm[] = [
  ...
  },
  {
    ...
    relatedTerms: ["sublime-baski", "ofset-baski"],
  },
  {
    slug: "sublime-baski",
    term: "Sublime Baskı",
  ...
  // === TASARIM ===
  {
    ...
    category: "tasarim",
    examples: ["Başlık + gövde için 2 font ailesi", "Kartvizitte 8-10 punto iletişim bilgisi"],
    relatedTerms: ["outline", "gorsel-hiyerarsi"],
    synonyms: ["yazı düzeni", "font düzeni"],
  },
  {
