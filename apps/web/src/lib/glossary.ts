...
export const glossary: GlossaryTerm[] = [
  ...
  // === BASKI ===
  {
    ...
    relatedTerms: ["dijital-baski", "ayar-baski"],
  },
  {
    slug: "dijital-baski",
    term: "Dijital Baskı",
    ...
    relatedTerms: ["ofset-baski", "serigrafi"],
  },
  {
    slug: "serigrafi",
    term: "Serigrafi",
  ...
  // === FORMAT ===
  {
    ...
    relatedTerms: ["dpi", "icc-profil", "outline"],
  },
  {
    slug: "dpi",
    term: "DPI (Çözünürlük)",
  ...
  // === TASARIM ===
  {
    slug: "tipografi",
    term: "Tipografi",
    shortDef: "Yazı tipi seçimi, punto, satır aralığı ve hiyerarşi — okunaklılık ve estetiği belirler.",
    longDef:
      "Tipografi, matbaa tasarımının temel bileşenidir. Font seçimi, punto büyüklüğü, satır aralığı (leading), harf aralığı (tracking) ve sözcük aralığı (kerning) kararlarının bütünüdür. Başlık, altbaşlık ve gövde metni için farklı ağırlık ve ölçek kullanmak görsel hiyerarşi oluşturur. Baskıda okunabilirlik açısından serif fontlar uzun metinlerde, sans-serif fontlar başlık ve kısa formlarda tercih edilir. Font dosyaları matbaaya gönderilmeden önce outline'a çevrilmeli ya da PDF'e gömülmelidir.",
    category: "tasarim",
    examples: ["Helvetica Neue 24pt başlık", "Times New Roman 11pt gövde metni"],
